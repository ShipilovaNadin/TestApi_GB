...
class OperationHelper(BasePage):
    ...
    def enter_contact_email(self, word):
        self. enter_text_into_field(TestSearchLocators.ids["LOCATOR_EMAIL_FIELD"], word, description="contact email form")
    
    def enter_contact_content(self, word):
        self. enter_text_into_field(TestSearchLocators.ids["LOCATOR_CONTENT_FIELD"], word, description="contact content form")
